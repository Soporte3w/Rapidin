        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">
              Solicitud de Préstamo - <span className="text-primary">Colombia</span>
            </h1>
          </div>
          <p className="text-sm sm:text-base text-gray-600 mt-2">
            Completa el formulario para solicitar tu préstamo en pesos colombianos
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
              <div className="sm:col-span-2">
                <label htmlFor="dni" className="block text-sm font-semibold text-gray-700 mb-2">
                  DNI (10 dígitos) <span className="text-primary">*</span>
                </label>
                <input
                  id="dni"
                  type="text"
              ...
              <div className="sm:col-span-2">
                <label htmlFor="requested_amount" className="block text-sm font-semibold text-gray-700 mb-2">
                  Monto Solicitado (COP) <span className="text-primary">*</span>
                </label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 font-medium">COP</span>
                  <input
                    id="requested_amount"
                    type="number"
